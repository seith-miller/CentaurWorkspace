...
class MyProjectCrew:
    def __init__(self):
        ...
        self.google_drive_navigation_tool = GoogleDriveNavigationTool()
    ...
    def create_agents(self):
        return [
            Worker(
                ...
                tools=[
                    self.custom_tool,
                    self.google_drive_navigation_tool,
            ...
            GenericTester(
                ...
                backstory=(
                    "You are a tester focused on assessing "
                    "the quality of code generated by GPT-3.5."
                ),
                llm_provider="openai",
                model="gpt-3.5-turbo",
            ),
            GenericTester(
                ...
                goal="Test the quality of code generation",
                backstory=(
                    "You are a tester focused on assessing the "
                    "quality of code generated by GPT-4."
                ),
                llm_provider="openai",
                model="gpt-4",
            ),
